...
# Trường nhập thông điệp
message_label = Label(root, text="Enter Message:", font=("Arial", 18))
message_label.pack()
message_entry = tk.Entry(root, font=("Arial", 18))
message_entry.pack()

# Trường nhập mật khẩu
password_label = Label(root, text="Enter Password:", font=("Arial", 18))
password_label.pack()
